...
public class GuiMachineBasicFurnace extends GuiInventoryBase {
    protected GuiTooltip fuelTooltip, progressTooltip;
    protected TileEntityBasicFurnace tile;

    public GuiMachineBasicFurnace(InventoryPlayer player, TileEntityBasicFurnace tile) {
        super(new ContainerMachineBasicFurnace(player, tile), new ResourceLocation("complexwiring", "textures/gui/machine/basic/" + EnumBasicMachine.FURNACE.getUnlocalizedName() + ".png"));
        this.tile = tile;
    }
