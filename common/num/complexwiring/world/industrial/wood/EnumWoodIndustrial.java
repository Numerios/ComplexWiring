...
public enum EnumWoodIndustrial {
    ...
    LIGHT_DOUBLESLAB(Strings.INDUSTRIAL_WOOD_DOUBLESLAB, Type.DOUBLESLAB),
    DARK_DOUBLESLAB(Strings.INDUSTRIAL_WOOD_DARK_DOUBLESLAB, Type.DOUBLESLAB),
    ...
    public enum Type {
        SMOOTH, ROUGH, TILED, SMALLTILED, DOUBLESLAB, PANEL, CHISELED, PAVED
    }
}
