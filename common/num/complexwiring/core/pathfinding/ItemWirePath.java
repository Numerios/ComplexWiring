...
public class ItemWirePath implements Comparable<ItemWirePath> {
    ...
    public ItemWirePath(MCVector3 target, ForgeDirection heading, ForgeDirection direction, int distance) {
        this.target = target;
    ...
    public int compareTo(ItemWirePath route) {
    ...
    public boolean equals(Object obj) {
        if (this == obj)
            return true;
        if (obj == null || !(obj instanceof ItemWirePath))
            return false;

        ItemWirePath path = (ItemWirePath) obj;
